    ...
    <div className="terms-and-conditions">
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Sharinghood.
        </li>
        <li>
      ...
      <p>
        ...
        copyright agent via email at sharinghood@gmail.com and include in Your
      ...
      <ul>
        <li>
          ...
          behalf of the owner of the copyright&apso;s interest.
        </li>
        <li>
      ...
      <p>
        You can contact our copyright agent via email at sharinghood@gmail.com.
      </p>
      <p>
      ...
      <h1>&quotAS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
      <p>
        The Service is provided to You &quot;AS IS&quot; and &quot;AS
        AVAILABLE&quot and with all faults and defects without warranty of any
      ...
      <ul>
        <li>By email: sharinghood@gmail.com</li>
      </ul>
      <style jsx>
        {`
